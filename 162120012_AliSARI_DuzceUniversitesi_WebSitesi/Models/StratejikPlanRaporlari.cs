...
{
    public class StratejikPlanRaporlari
    {
        [Key]
        ...
        public int StratejikPlanRaporlariKategoriID { get; set; }
        public StratejikPlanRaporlariKategori StratejikPlanRaporlariKategori { get; set; }//Bütçe Bilgileri Kategorileri ile ilişki kurdum
